...
for r=chregs
    cnt=nnz(strcmp(meta.reg_tree(5,:),r{1}));
    pos=nnz(strcmp(meta.reg_tree(5,:),r{1}) & any((dur.wrsp(:,:)<0.05).'));
...
for r=chregs
    ...
    pos=nnz(strcmp(meta.reg_tree(5,sess_sel),r{1}) & any((ord.out_.anovanp(:,:)<0.05).'));
