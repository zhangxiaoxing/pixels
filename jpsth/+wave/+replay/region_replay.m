...
fh=figure();
hold on
bh=bar(mm([1,2;3,4;5,6;7,8]),'grouped','FaceColor','none','EdgeColor','k');
bh(1).FaceColor='k';
errorbar([bh.XEndPoints],[bh.YEndPoints],rci(1,[1:2:7,2:2:8])-mm([1:2:7,2:2:8]).',rci(2,[1:2:7,2:2:8])-mm([1:2:7,2:2:8]).','k.');
set(gca,'XTick',1:4,'XTickLabel',{'Delay','ITI','Before task','After task'})
% ylim([0,2])
