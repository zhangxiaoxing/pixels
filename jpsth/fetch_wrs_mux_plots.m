...
[fhchain,cstr,cmat]=wave.replay.plot_replay_sess({chain_raw},...
    {'Delay','Test','Prior ITI','Later ITI','Before session','After session',},...
    'title','chains correct trial','feat_sel',[1 4 8 5 11 12],'ref_line',true,'median_value',true);


[fhring,rstr,rmat]=wave.replay.plot_replay_sess({ring_raw},...
    {'Delay','Test','Prior ITI','Later ITI','Before session','After session',},...
    'title','loops correct trial','feat_sel',[1 4 8 5 11 12],'ref_line',true,'median_value',true);
...
[fhb,estr,emat]=wave.replay.plot_replay_sess({chain_corr_err},...
