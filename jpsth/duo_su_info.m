...
% error_list=cell(0);
sums=cell(0,8);
fs=dir(sprintf('/home/zx/neupix/duo_xcorr_perfile/0604_selec_XCORR_duo_*_%d*%d*',bin_range(1),bin_range(2)));
disp(length(fs))
% pause
for i=1:length(fs)
    tracks=2;
...
keyboard
save('selec_duo_XCORR_sums_delay_6_1_2_2msbin.mat','sums','-v7.3')
