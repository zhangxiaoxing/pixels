classdef su_pairs
    methods (Static)
        ...
        function incong=get_incongru(waveid)
            incong=(waveid(:,1)~=waveid(:,2) & all(waveid>0,2) & all(waveid<5,2))...
                | (waveid(:,1)~=waveid(:,2) & all(waveid>4,2) & all(waveid<7,2))...
                | (waveid(:,1)~=waveid(:,2) & all(waveid>6,2))...
