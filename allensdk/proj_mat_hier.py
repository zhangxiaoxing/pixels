...
def get_all_children(structure_tree,rootid,lvl=7):
    ...
    if len(curr_str['structure_id_path'])<lvl:
        ...
        return [get_all_children(structure_tree, x) for x in children]
    else:
        return curr_str['id']
...
if __name__=='__main__':
    ...
    ctx_targets=list(flatten(get_all_children(structure_tree, 688)))
